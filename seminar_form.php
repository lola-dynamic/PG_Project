...
if ($student->num_rows > 0) {
    ...
    $email = $sup['email'];
    $no_of_semester = $sup['no_of_semester'];
}
...
//    }
    ...
    if ($num_rows > 0) {
        ...
        $sql = "INSERT INTO form(email, first_name, middle_name, last_name, reg_number, leave_absence, project_title, seminar_type, degree_study, document, phone_no, seminar_month, supervisor_name, co_sup_name, hash, no_of_semester)
 VALUES ('$email','$first_name','$middle_name', '$last_name', '$regno', '$loa', '$project_title', '$seminar_type', '$dos', '$file', '$phone_no', '$seminar_month', '$supervisor_name', '$co_sup_name', '$hash', '$no_of_semester')";
